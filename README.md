...
| 항목 | 내용 |
|---|---|
| **과정명** | (특별교육) [인공지능 : LLM 마스터] — **Part 1** (5개 파트 중 첫 번째) |
| **주제** | LLM 아키텍처 분석 및 HuggingFace, LangChain 활용 |
| **일정** | 2026-08-08 ~ 08-09 · **2일 / 총 12시간** (Day 1: 6시간, Day 2: 6시간) |
| **난이도** | 고급 |
| **강사** | **김의중** (아이덴티파이 대표) |
| **교재** | **딥러닝 개념과 활용** (김의중 저) |
...
```bash
git clone https://github.com/choki0715/LLM_master_part1.git
cd LLM_master_part1
```
...
| 파트 | 일정 | 주제 |
|---|---|---|
| **Part 1** *(본 저장소)* | 2026-08-08 ~ 08-09 | LLM 아키텍처 분석 및 HuggingFace, LangChain 활용 |
